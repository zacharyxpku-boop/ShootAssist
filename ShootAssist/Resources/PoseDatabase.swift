...
let poseDatabase: [PoseCategory] = [
    ...
    PoseCategory(name: "全身照", icon: "🧍‍♀️", poses: [
        ...
        PoseData(name: "坐台阶", description: "坐在台阶上，腿自然伸展", tips: ["坐1/3位置，别坐满", "一条腿弯曲一条伸直", "身体微微前倾"], difficulty: 1, bestFor: "校园、公园", cameraAngle: "微俯15°", icon: "figure.mind.and.body"),
        PoseData(name: "背影照", description: "背对镜头，展示穿搭或风景", tips: ["稍微侧身更好看", "头可以微转", "手可以拿帽子/包包"], difficulty: 1, bestFor: "风景、穿搭", cameraAngle: "平视", icon: "figure.walk"),
    ]),
    PoseCategory(name: "情侣照", icon: "💑", poses: [
        ...
        PoseData(name: "公主抱", description: "一人抱起另一人", tips: ["被抱的人搂住脖子", "抱的人别太僵硬", "连拍选最自然的"], difficulty: 3, bestFor: "婚纱、纪念", cameraAngle: "微仰", icon: "person.2"),
    ]),
    ...
    PoseCategory(name: "街拍", icon: "🏙️", poses: [
        PoseData(name: "走斑马线", description: "走在斑马线上回头", tips: ["走在线中间", "步伐大一点", "连拍抓拍"], difficulty: 2, bestFor: "城市街拍", cameraAngle: "微仰", icon: "car"),
        PoseData(name: "橱窗前", description: "站在好看的橱窗/涂鸦墙前", tips: ["身体微侧", "可以看橱窗不看镜头", "跟背景颜色呼应"], difficulty: 1, bestFor: "逛街、旅行", cameraAngle: "平视", icon: "building.2"),
    ...
    PoseCategory(name: "旅行", icon: "✈️", poses: [
        ...
        PoseData(name: "行李箱合照", description: "拉着行李箱回头", tips: ["行李箱颜色鲜艳加分", "穿搭和场景呼应", "机场/车站最经典"], difficulty: 1, bestFor: "出发/到达", cameraAngle: "平视", icon: "suitcase"),
    ]),
